...
func (db MSDBHandler) UpData(rcv model.IEntity) {
	...
	switch cmdcode {
	case 0x1202: //添加任务
		posTask := dbcore.DBTask{Sql: "insert into biz_DriverLogDetailed(SimNum,DriverId,DriverName,OrgName,[State],ReceTime,UpDataTime,WorkLicenseId)Values('1','2','3','4',5,GETDATE(),'2018-04-20 16:10:16','6');"}
